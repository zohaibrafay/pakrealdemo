...
const Brick = () => {
  return (
    <Fragment>
            <MetaData title={'BrickCalculator'} />
    <div className="row">
    ...
    <div className="container container-fluid">
        ...
        <form className="shadow-lg" encType='multipart/form-data'>
            <h1 className="mb-4">Brick Calculator</h1>
            ...
            <div className="form-group">
              ...
              <div className="form-group">
              <label for="name_field">Size of Brick (Length) in cm</label>
              <input
                type="text"
                id="name_field"
                className="form-control"
            ...
            <div className="form-group">
              <label for="name_field">Size of Brick (Width) in cm</label>
              <input
                type="text"
                id="name_field"
                className="form-control"
            ...
            <div className="form-group">
              <label for="name_field">Size of Brick (Height) in cm</label>
              <input
                type="text"
                id="name_field"
                className="form-control"
